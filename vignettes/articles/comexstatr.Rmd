...
try(comexstat_download(years = 2014:2024, types = "ncm"
                       , ssl_verifypeer=FALSE
                       ))

comexstat_ncm_f <- comexstat_ncm()|>filter(year>=2014, year<=2023)
...
```{r deflated}
selected_deflated <- comexstat_ncm_f%>%
...
```{r deflated2}
balance_deflated <- comexstat_ncm_f%>%
