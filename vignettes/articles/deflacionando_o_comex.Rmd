...
subtitle: "Análise de Dados de Comércio Exterior Brasileiro Deflacionados Utilizando o Pacote comexstatr"
...
Esta análise utiliza o pacote comexstatr do R para baixar, limpar e analisar dados de comércio exterior brasileiro, com foco na importância da desinflação. A inflação distorce o valor real do comércio ao longo do tempo, e a desinflação é o processo de ajustar esses valores a um ano base comum para remover essa distorção.
...
```{r config}
library(comexstatr)      # Pacote principal para análise de dados da Comex
