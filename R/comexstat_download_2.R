...
#'
#' @export
comex_download <- function(years = 2024, directions = c("imp", "exp"), types = c("hs4", "ncm"), download_aux = TRUE,
    clean_aux = TRUE, cache = TRUE, .progress = TRUE, n_tries = 30, check = FALSE, ...) {
    ...
    dplyr::mutate(dir = file.path(comexstatr:::cdircomex, type, paste0("direction=", direction)), path = file.path(dir,
